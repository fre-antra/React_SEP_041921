			...
			<div class = "container-fluid">
					...
					<div class = "development-summary">
						<div class = "col-sm-1 col-md-1">
							<div class = "development-img">
								<img class = "img-responsive" src = {developerdesign} alt="img"></img>
							</div>
						</div>
					...
					<div class = "responsive-summary">
						<div class = "col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
							<div class = "responsive-img">
								<img class = "img-responsive" src = {responsivedesign} alt="img"></img>
							</div>
						</div>
				...
				<div class = "row">
					<div class = "ideas-summary">
						<div class = "col-sm-1 col-md-1">
							<div class = "idea-img">
								<img class = "img-responsive" src = {innovativesolutions} alt="img"></img>
							</div>
						</div>
