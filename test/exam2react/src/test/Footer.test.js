...
describe('Footer Component', () => {
    ...
    it('brings user to Portfolio section when clicked on Portfolio link', async () => {
        ...
        expect(screen.getByTestId('portfolio-header')).toHaveTextContent('Projects and Portfolio')
    })
    ...
    it('brings user to Contact section when clicked on Contact link', async () => {
        ...
        await render(<Contact></Contact>)
        expect(screen.getByTestId('contact-header')).toHaveTextContent('Contact')
    })
